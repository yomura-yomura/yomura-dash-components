...
function __init__()
    ...
    external_url = "https://unpkg.com/yomura_dash_components@3.8.0/yomura_dash_components/yomura_dash_components.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/yomura_dash_components@3.8.0/yomura_dash_components/yomura_dash_components.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
